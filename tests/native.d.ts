...
declare namespace bytecode {
     ...
     */
    export function compile(path: string, link?: boolean, scriptMode?: boolean, fileSystem?: io.FileSystem): runtime.Program

    /**
     * Compile as a library.
     */
    export function compileLib(path: string, link?: boolean, scriptMode?: boolean, fileSystem?: io.FileSystem): runtime.Program
     ...
     * @param link load and link dynamic libraries also
     * @param fs the file trusted. If empty it will use the current fs.
     */
    export function load(path: string, link?: boolean, fs?: io.FileSystem): runtime.Program
...
declare namespace runtime {
    ...
    export function removeTrust(): void
    ...
    export interface Program {
        ...
        /**
         * Add a dynamic link to a binary
         */
        addDynamicLink(libFile: string): void

        /**
         * Remove a dynamic link to a binary
         */
        removeDynamicLink(libFile: string): void
